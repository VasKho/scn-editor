...
#include "deleteScnPageKeynodes.generated.hpp"

namespace scn_editor_module {
  class deleteScnPageKeynodes : public ScObject {
    SC_CLASS()
    SC_GENERATED_BODY()
    ...
    SC_PROPERTY(Keynode("action_delete_scn_page"), ForceCreate)
    static ScAddr action_delete_scn_page;
